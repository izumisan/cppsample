...
PROTOBUF_NAMESPACE_OPEN
template<> ::ServerStreamingRpc::FooRequest* Arena::CreateMaybeMessage<::ServerStreamingRpc::FooRequest>(Arena*);
template<> ::ServerStreamingRpc::FooResponse* Arena::CreateMaybeMessage<::ServerStreamingRpc::FooResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace ServerStreamingRpc {
...
class FooRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ServerStreamingRpc.FooRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ServerStreamingRpc.FooRequest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:ServerStreamingRpc.FooRequest)
 private:
  class _Internal;
...
class FooResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ServerStreamingRpc.FooResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ServerStreamingRpc.FooResponse";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:ServerStreamingRpc.FooResponse)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 FooRequest::value() const {
  // @@protoc_insertion_point(field_get:ServerStreamingRpc.FooRequest.value)
...
inline void FooRequest::set_value(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ServerStreamingRpc.FooRequest.value)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 FooResponse::value() const {
  // @@protoc_insertion_point(field_get:ServerStreamingRpc.FooResponse.value)
  return _internal_value();
}
...
inline void FooResponse::set_value(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_value(value);
  // @@protoc_insertion_point(field_set:ServerStreamingRpc.FooResponse.value)
}
