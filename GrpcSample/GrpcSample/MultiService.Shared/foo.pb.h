...
PROTOBUF_NAMESPACE_OPEN
template<> ::MultiService::FooRequest* Arena::CreateMaybeMessage<::MultiService::FooRequest>(Arena*);
template<> ::MultiService::FooResponse* Arena::CreateMaybeMessage<::MultiService::FooResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace MultiService {
...
class FooRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MultiService.FooRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "MultiService.FooRequest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:MultiService.FooRequest)
 private:
  class _Internal;
...
class FooResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MultiService.FooResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "MultiService.FooResponse";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:MultiService.FooResponse)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 FooRequest::value() const {
  // @@protoc_insertion_point(field_get:MultiService.FooRequest.value)
...
inline void FooRequest::set_value(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:MultiService.FooRequest.value)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 FooResponse::value() const {
  // @@protoc_insertion_point(field_get:MultiService.FooResponse.value)
  return _internal_value();
}
...
inline void FooResponse::set_value(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_value(value);
  // @@protoc_insertion_point(field_set:MultiService.FooResponse.value)
}
